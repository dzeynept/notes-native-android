...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NotesHolder> {
    ...
    NotesAdapter(List<String> notes_list, Context context, NoteInterface noteInterface) {
    ...
    public void onBindViewHolder(@NonNull NotesHolder holder, final int position) {
        holder.notes.setText(notes_list.get(position));
/*
        viewHolder.detail_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                noteInterface.showPopup(position);
            }
        });*/
